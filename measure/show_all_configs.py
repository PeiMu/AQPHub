...
def main():
    ...
    CONFIGS = [
        ...
        ("expr_tmpl",
         f"duckdb_{split}_expr_none_jitcache_single_run_parameterized_llvm_breakdown_time_log.csv", True),
        # ("expr_simd_tmpl",
        #  f"duckdb_{split}_expr_auto_jitcache_single_run_parameterized_breakdown_time_log.csv", True),
        ("expr_fi_tmpl",
         f"duckdb_{split}_expr_none_jitcache_single_run_parameterized_fastisel_breakdown_time_log.csv", True),
        # ("expr_fi_simd_tmpl",
        #  f"duckdb_{split}_expr_auto_jitcache_single_run_parameterized_fcfastisel_breakdown_time_log.csv", True),
        ("expr_tpde_tmpl",
         f"duckdb_{split}_expr_none_jitcache_single_run_parameterized_tpde_breakdown_time_log.csv", True),
        ("oper_tmpl",
         f"duckdb_{split}_operator_none_jitcache_single_run_parameterized_llvm_breakdown_time_log.csv", True),
        # ("oper_simd_tmpl",
        #  f"duckdb_{split}_operator_auto_jitcache_single_run_parameterized_breakdown_time_log.csv", True),
        ("oper_fi_tmpl",
         f"duckdb_{split}_operator_none_jitcache_single_run_parameterized_fastisel_breakdown_time_log.csv", True),
        # ("oper_fi_simd_tmpl",
        #  f"duckdb_{split}_operator_auto_jitcache_single_run_parameterized_fcfastisel_breakdown_time_log.csv", True),
        ("oper_tpde_tmpl",
         f"duckdb_{split}_operator_none_jitcache_single_run_parameterized_tpde_breakdown_time_log.csv", True),
        ("pipe_tmpl",
         f"duckdb_{split}_pipeline_none_jitcache_single_run_parameterized_llvm_breakdown_time_log.csv", True),
        # ("pipe_simd_tmpl",
        #  f"duckdb_{split}_pipeline_auto_jitcache_single_run_parameterized_breakdown_time_log.csv", True),
        ("pipe_fi_tmpl",
         f"duckdb_{split}_pipeline_none_jitcache_single_run_parameterized_fastisel_breakdown_time_log.csv", True),
        # ("pipe_fi_simd_tmpl",
        #  f"duckdb_{split}_pipeline_auto_jitcache_single_run_parameterized_fcfastisel_breakdown_time_log.csv", True),
        ("pipe_tpde_tmpl",
         f"duckdb_{split}_pipeline_none_jitcache_single_run_parameterized_tpde_breakdown_time_log.csv", True),
        ("q_full_tmpl",
         f"duckdb_{split}_query_none_jitcache_single_run_parameterized_llvm_breakdown_time_log.csv", True),
        ("q_fasti_tmpl",
         f"duckdb_{split}_query_none_jitcache_single_run_parameterized_fastisel_breakdown_time_log.csv", True),
        ("q_tpde_tmpl",
         f"duckdb_{split}_query_none_jitcache_single_run_parameterized_tpde_breakdown_time_log.csv", True),
        ("q_tmpl_srec",
         f"duckdb_{split}_query_none_jitcache_single_run_parameterized_specrecompile_llvm_breakdown_time_log.csv", True),
        # ("q_tmpl_sint",
        #  f"duckdb_{split}_query_none_jitcache_single_run_parameterized_specinterpret_breakdown_time_log.csv", True),
        ("q_fasti_tmpl_srec",
         f"duckdb_{split}_query_none_jitcache_single_run_parameterized_specrecompile_fastisel_breakdown_time_log.csv", True),
        # ("q_fasti_tmpl_sint",
        #  f"duckdb_{split}_query_none_jitcache_single_run_parameterized_specinterpret_fcfastisel_breakdown_time_log.csv", True),
        ("q_tpde_tmpl_srec",
         f"duckdb_{split}_query_none_jitcache_single_run_parameterized_specrecompile_tpde_breakdown_time_log.csv", True),
        # ("q_tpde_tmpl_sint",
        #  f"duckdb_{split}_query_none_jitcache_single_run_parameterized_specinterpret_fctpde_breakdown_time_log.csv", True),
        # ("q_simd_tmpl",
        #  f"duckdb_{split}_query_auto_jitcache_single_run_parameterized_breakdown_time_log.csv", True),
        # ("q_simd_fasti_tmpl",
        #  f"duckdb_{split}_query_auto_jitcache_single_run_parameterized_fcfastisel_breakdown_time_log.csv", True),
        # ("q_simd_tmpl_srec",
        #  f"duckdb_{split}_query_auto_jitcache_single_run_parameterized_specrecompile_breakdown_time_log.csv", True),
        # ("q_simd_tmpl_sint",
        #  f"duckdb_{split}_query_auto_jitcache_single_run_parameterized_specinterpret_breakdown_time_log.csv", True),
        # ("q_simd_fasti_tmpl_srec",
        #  f"duckdb_{split}_query_auto_jitcache_single_run_parameterized_specrecompile_fcfastisel_breakdown_time_log.csv", True),
        # ("q_simd_fasti_tmpl_sint",
        #  f"duckdb_{split}_query_auto_jitcache_single_run_parameterized_specinterpret_fcfastisel_breakdown_time_log.csv", True),
        ("tuned_tmpl",
         f"duckdb_{split}_query_none_jitcache_single_run_parameterized_tuned_breakdown_time_log.csv", True),
        ("tuned_tmpl_srec",
         f"duckdb_{split}_query_none_jitcache_single_run_parameterized_specrecompile_tuned_breakdown_time_log.csv", True),
