...
def main():
    ...
    CONFIGS = [
        ...
        ("interp_hl",
         f"duckdb_{split}_none_off_hidelatency_breakdown_time_log.csv", False),
        ("expr_hl",
         f"duckdb_{split}_expr_none_hidelatency_breakdown_time_log.csv", True),
        ("expr_simd_hl",
         f"duckdb_{split}_expr_auto_hidelatency_breakdown_time_log.csv", True),
        ("operator_hl",
         f"duckdb_{split}_operator_none_hidelatency_breakdown_time_log.csv", True),
        ("operator_simd_hl",
         f"duckdb_{split}_operator_auto_hidelatency_breakdown_time_log.csv", True),
        ("pipeline_hl",
         f"duckdb_{split}_pipeline_none_hidelatency_breakdown_time_log.csv", True),
        ("pipeline_simd_hl",
         f"duckdb_{split}_pipeline_auto_hidelatency_breakdown_time_log.csv", True),
        ("query_full_hl",
         f"duckdb_{split}_query_none_hidelatency_breakdown_time_log.csv", True),
        ("query_fastisel_hl",
         f"duckdb_{split}_query_none_fcfastisel_hidelatency_breakdown_time_log.csv", True),
        ("query_tpde_hl",
         f"duckdb_{split}_query_none_fctpde_hidelatency_breakdown_time_log.csv", True),
        ("query_full_specrecomp_hl",
         f"duckdb_{split}_query_none_specrecompile_hidelatency_breakdown_time_log.csv", True),
        ("query_full_specinterp_hl",
         f"duckdb_{split}_query_none_specinterpret_hidelatency_breakdown_time_log.csv", True),
        ("query_fasti_specrecomp_hl",
         f"duckdb_{split}_query_none_specrecompile_fcfastisel_hidelatency_breakdown_time_log.csv", True),
        ("query_fasti_specinterp_hl",
         f"duckdb_{split}_query_none_specinterpret_fcfastisel_hidelatency_breakdown_time_log.csv", True),
        ("query_tpde_specrecomp_hl",
         f"duckdb_{split}_query_none_specrecompile_fctpde_hidelatency_breakdown_time_log.csv", True),
        ("query_tpde_specinterp_hl",
         f"duckdb_{split}_query_none_specinterpret_fctpde_hidelatency_breakdown_time_log.csv", True),
    ]
