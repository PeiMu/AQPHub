...
FILTER='grep -v -E "^Running|^==|^Execution|^$|^waiting|^server|^ANALYZ|^duckdb runs:|^lingodb runs:|\(base\)|^\[AQP|^\[LingoDB|^\[Storage|^\[CSR|^\[Dim|^\[RelationshipCenter|^\[IRQuerySplitter|^  [a-z_]*: [0-9]* rows$|^Found [0-9]|^Run |^Passed:|^Failed:|^Total |^Benchmark|^Average|^--- Iteration|^Test FAILED|^Error:|^warning:|^Do not support yet|^same engine"'
...
JIT_CONFIGS=(
  ...
  # ============================================================
  # topdown (SDS) — mirrors node-based configs (spec-jit is
  # currently gated to NODE_BASED in ir_query_splitter.cpp,
  # so recompile configs behave identically to spec=off;
  # kept for coverage parity with breakdown_measurement_script)
  # ============================================================
  # no-jit
  ...
  # ============================================================
  # cache=off
  "duckdb|topdown|expr|none|duckdb_job_node-based_golden.txt|recompile"
  "duckdb|topdown|expr|none|duckdb_job_node-based_golden.txt|recompile||fastisel"
  "duckdb|topdown|expr|none|duckdb_job_node-based_golden.txt|recompile||tpde"
  "duckdb|topdown|operator|none|duckdb_job_node-based_golden.txt|recompile"
  "duckdb|topdown|operator|none|duckdb_job_node-based_golden.txt|recompile||fastisel"
  "duckdb|topdown|operator|none|duckdb_job_node-based_golden.txt|recompile||tpde"
  "duckdb|topdown|query|none|duckdb_job_node-based_golden.txt|recompile"
  "duckdb|topdown|query|none|duckdb_job_node-based_golden.txt|recompile||fastisel"
  "duckdb|topdown|query|none|duckdb_job_node-based_golden.txt|recompile||tpde"
  # cache=single-run-strict + spec=recompile
  "duckdb|topdown|expr|none|duckdb_job_node-based_golden.txt|recompile|single-run-strict"
  "duckdb|topdown|expr|none|duckdb_job_node-based_golden.txt|recompile|single-run-strict|fastisel"
  "duckdb|topdown|expr|none|duckdb_job_node-based_golden.txt|recompile|single-run-strict|tpde"
  "duckdb|topdown|operator|none|duckdb_job_node-based_golden.txt|recompile|single-run-strict"
  "duckdb|topdown|operator|none|duckdb_job_node-based_golden.txt|recompile|single-run-strict|fastisel"
  "duckdb|topdown|operator|none|duckdb_job_node-based_golden.txt|recompile|single-run-strict|tpde"
  "duckdb|topdown|query|none|duckdb_job_node-based_golden.txt|recompile|single-run-strict"
  "duckdb|topdown|query|none|duckdb_job_node-based_golden.txt|recompile|single-run-strict|fastisel"
  "duckdb|topdown|query|none|duckdb_job_node-based_golden.txt|recompile|single-run-strict|tpde"
  # cache=single-run-template + spec=recompile
  "duckdb|topdown|expr|none|duckdb_job_node-based_golden.txt|recompile|single-run-template"
  "duckdb|topdown|expr|none|duckdb_job_node-based_golden.txt|recompile|single-run-template|fastisel"
  "duckdb|topdown|expr|none|duckdb_job_node-based_golden.txt|recompile|single-run-template|tpde"
  "duckdb|topdown|operator|none|duckdb_job_node-based_golden.txt|recompile|single-run-template"
  "duckdb|topdown|operator|none|duckdb_job_node-based_golden.txt|recompile|single-run-template|fastisel"
  "duckdb|topdown|operator|none|duckdb_job_node-based_golden.txt|recompile|single-run-template|tpde"
  "duckdb|topdown|query|none|duckdb_job_node-based_golden.txt|recompile|single-run-template"
  "duckdb|topdown|query|none|duckdb_job_node-based_golden.txt|recompile|single-run-template|fastisel"
  "duckdb|topdown|query|none|duckdb_job_node-based_golden.txt|recompile|single-run-template|tpde"
  # cache=full + spec=recompile
  "duckdb|topdown|expr|none|duckdb_job_node-based_golden.txt|recompile|full"
  "duckdb|topdown|expr|none|duckdb_job_node-based_golden.txt|recompile|full|fastisel"
  "duckdb|topdown|expr|none|duckdb_job_node-based_golden.txt|recompile|full|tpde"
  "duckdb|topdown|operator|none|duckdb_job_node-based_golden.txt|recompile|full"
  "duckdb|topdown|operator|none|duckdb_job_node-based_golden.txt|recompile|full|fastisel"
  "duckdb|topdown|operator|none|duckdb_job_node-based_golden.txt|recompile|full|tpde"
  "duckdb|topdown|query|none|duckdb_job_node-based_golden.txt|recompile|full"
  "duckdb|topdown|query|none|duckdb_job_node-based_golden.txt|recompile|full|fastisel"
  "duckdb|topdown|query|none|duckdb_job_node-based_golden.txt|recompile|full|tpde"
)
