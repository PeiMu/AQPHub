...
#bash ./measure_breakdown_time_aqp.sh job postgresql node-based query none on on on all single-run-parameterized off llvm && \
#bash ./measure_breakdown_time_aqp.sh job postgresql node-based query none on on on all single-run-parameterized off fastisel && \
#bash ./measure_breakdown_time_aqp.sh job postgresql node-based query none on on on all single-run-parameterized off tpde && \
bash ./measure_breakdown_time_aqp.sh job postgresql auto query none on on on all single-run-parameterized off llvm ${RESULT_DIR}/tuned_cross_split_postgresql.json && \
...
#bash ./measure_breakdown_time_aqp.sh job postgresql node-based query none on on on all single-run-parameterized recompile llvm && \
#bash ./measure_breakdown_time_aqp.sh job postgresql node-based query none on on on all single-run-parameterized recompile fastisel && \
#bash ./measure_breakdown_time_aqp.sh job postgresql node-based query none on on on all single-run-parameterized recompile tpde && \
bash ./measure_breakdown_time_aqp.sh job postgresql auto query none on on on all single-run-parameterized recompile llvm ${RESULT_DIR}/tuned_cross_split_postgresql.json && \
...
# ---- cache=single-run-parameterized, spec=off: 4 ----
bash ./measure_breakdown_time_aqp.sh job postgresql topdown query none on on on all single-run-parameterized off llvm && \
bash ./measure_breakdown_time_aqp.sh job postgresql topdown query none on on on all single-run-template off llvm && \
#bash ./measure_breakdown_time_aqp.sh job postgresql topdown query none on on on all single-run-parameterized off fastisel && \
bash ./measure_breakdown_time_aqp.sh job postgresql topdown query none on on on all single-run-parameterized off tpde && \
...
# ---- cache=single-run-parameterized, spec=recompile: 4 ----
bash ./measure_breakdown_time_aqp.sh job postgresql topdown query none on on on all single-run-parameterized recompile llvm && \
bash ./measure_breakdown_time_aqp.sh job postgresql topdown query none on on on all single-run-template recompile llvm && \
#bash ./measure_breakdown_time_aqp.sh job postgresql topdown query none on on on all single-run-parameterized recompile fastisel && \
bash ./measure_breakdown_time_aqp.sh job postgresql topdown query none on on on all single-run-parameterized recompile tpde && \
