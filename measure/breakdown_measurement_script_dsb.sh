...
python3 tune_per_subquery.py --bench=dsb node-based && \

# ---- cache=off, spec=off: tune (1) ----
bash ./measure_breakdown_time_dsb.sh duckdb node-based query none on on on all off off llvm dsb_result/tuned_per_subquery_node-based.json && \
...
bash ./measure_breakdown_time_dsb.sh duckdb node-based query none on on on all single-run-strict off llvm dsb_result/tuned_per_subquery_node-based.json && \
...
bash ./measure_breakdown_time_dsb.sh duckdb node-based query none on on on all single-run-template off llvm dsb_result/tuned_per_subquery_node-based.json && \
...
bash ./measure_breakdown_time_dsb.sh duckdb node-based query none on on on all full off llvm dsb_result/tuned_per_subquery_node-based.json && \
...
bash ./measure_breakdown_time_dsb.sh duckdb node-based query none on on on all off recompile llvm dsb_result/tuned_per_subquery_node-based.json && \
...
bash ./measure_breakdown_time_dsb.sh duckdb node-based query none on on on all single-run-strict recompile llvm dsb_result/tuned_per_subquery_node-based.json && \
...
bash ./measure_breakdown_time_dsb.sh duckdb node-based query none on on on all single-run-template recompile llvm dsb_result/tuned_per_subquery_node-based.json && \
...
bash ./measure_breakdown_time_dsb.sh duckdb node-based query none on on on all full recompile llvm dsb_result/tuned_per_subquery_node-based.json && \
...
# Generate tune JSON from cache=off CSVs produced above
python3 tune_per_subquery.py --bench=dsb topdown && \

# ---- cache=off, spec=off: tune (1) ----
bash ./measure_breakdown_time_dsb.sh duckdb topdown query none on on on all off off llvm dsb_result/tuned_per_subquery_topdown.json && \
...
bash ./measure_breakdown_time_dsb.sh duckdb topdown query none on on on all single-run-strict off llvm dsb_result/tuned_per_subquery_topdown.json && \
...
bash ./measure_breakdown_time_dsb.sh duckdb topdown query none on on on all single-run-template off llvm dsb_result/tuned_per_subquery_topdown.json && \
...
bash ./measure_breakdown_time_dsb.sh duckdb topdown query none on on on all full off llvm dsb_result/tuned_per_subquery_topdown.json && \
...
bash ./measure_breakdown_time_dsb.sh duckdb topdown query none on on on all off recompile llvm dsb_result/tuned_per_subquery_topdown.json && \
...
bash ./measure_breakdown_time_dsb.sh duckdb topdown query none on on on all single-run-strict recompile llvm dsb_result/tuned_per_subquery_topdown.json && \
...
bash ./measure_breakdown_time_dsb.sh duckdb topdown query none on on on all single-run-template recompile llvm dsb_result/tuned_per_subquery_topdown.json && \
...
bash ./measure_breakdown_time_dsb.sh duckdb topdown query none on on on all full recompile llvm dsb_result/tuned_per_subquery_topdown.json && \
